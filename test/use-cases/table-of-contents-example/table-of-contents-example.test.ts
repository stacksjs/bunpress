...
describe('Use Case: Table of Contents Example', () => {
  ...
  test('should generate HTML that matches expected output', async () => {
    ...
    expect(generatedHtml).toContain('<title>Table of Contents Example</title>')
    expect(generatedHtml).toContain('Comprehensive table of contents configuration and navigation examples for BunPress')
    ...
    expect(generatedHtml).toContain('Table of Contents Example')

    // Check for sidebar structure
    expect(generatedHtml).toContain('Overview')
    expect(generatedHtml).toContain('Basic TOC')
    expect(generatedHtml).toContain('Advanced Configuration')
    expect(generatedHtml).toContain('Custom Styling')
    expect(generatedHtml).toContain('Floating TOC')
    expect(generatedHtml).toContain('Mobile Navigation')
    expect(generatedHtml).toContain('Accessibility')
  ...
  test('should process frontmatter correctly', async () => {
    ...
    expect(html).toContain('Table of Contents Example')
    ...
    expect(html).toContain('/table-of-contents-example#overview')
    expect(html).toContain('Basic TOC')
    expect(html).toContain('/table-of-contents-example#basic-toc')
    expect(html).toContain('Advanced Configuration')
    expect(html).toContain('/table-of-contents-example#advanced-configuration')
  })
  ...
  test('should generate proper heading structure', async () => {
    ...
    expect(html).toContain('id="basic-toc"')
    expect(html).toContain('id="advanced-configuration"')
    expect(html).toContain('id="custom-styling"')
    expect(html).toContain('id="floating-toc"')
  ...
  test('should include code blocks with syntax highlighting', async () => {
    ...
    expect(html).toContain('tocTitle:')
    expect(html).toContain('function generateCustomTOC')
