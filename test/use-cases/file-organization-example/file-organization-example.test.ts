...
describe('Use Case: File Organization Example', () => {
  const testCase = 'file-organization-example'
  ...
  test('should generate HTML that matches expected output', async () => {
    ...
    expect(generatedHtml).toContain('<title>File Organization Example</title>')
    expect(generatedHtml).toContain('Best practices for organizing BunPress documentation files')
    ...
    expect(generatedHtml).toContain('File Organization Example')

    // Check for sidebar structure
    expect(generatedHtml).toContain('Overview')
    expect(generatedHtml).toContain('Directory Structure')
    expect(generatedHtml).toContain('Naming Conventions')
  ...
  test('should process frontmatter correctly', async () => {
    ...
    expect(html).toContain('File Organization Example')
    ...
    expect(html).toContain('/file-organization#overview')
    expect(html).toContain('Directory Structure')
    expect(html).toContain('/file-organization#directory-structure')
  })
  ...
  test('should generate proper heading structure', async () => {
    ...
    expect(html).toContain('id="directory-structure"')
    expect(html).toContain('id="naming-conventions"')
    expect(html).toContain('id="content-organization"')
  })
