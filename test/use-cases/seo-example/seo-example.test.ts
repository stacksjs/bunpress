...
describe('Use Case: SEO Example', () => {
  const _testCase = 'seo-example'
  const testDir = '/Users/mac/repos/stacks-org/bunpress/test/use-cases/seo-example'
  ...
  test('should generate HTML that matches expected output', async () => {
    ...
    expect(generatedHtml).toContain('<title>SEO Optimization Example</title>')
    expect(generatedHtml).toContain('Comprehensive SEO optimization techniques for BunPress documentation')
    ...
    expect(generatedHtml).toContain('SEO Optimization Example')

    // Check for sidebar structure
    expect(generatedHtml).toContain('Overview')
    expect(generatedHtml).toContain('Meta Tags')
    expect(generatedHtml).toContain('Structured Data')
    expect(generatedHtml).toContain('URL Structure')
    expect(generatedHtml).toContain('Performance')
    expect(generatedHtml).toContain('Sitemap & Robots')
  ...
  test('should process frontmatter correctly', async () => {
    ...
    expect(html).toContain('SEO Optimization Example')
    ...
    expect(html).toContain('/seo-example#overview')
    expect(html).toContain('Meta Tags')
    expect(html).toContain('/seo-example#meta-tags')
    expect(html).toContain('Structured Data')
    expect(html).toContain('/seo-example#structured-data')
  })
  ...
  test('should generate proper heading structure', async () => {
    ...
    expect(html).toContain('id="meta-tags"')
    expect(html).toContain('id="structured-data"')
    expect(html).toContain('id="url-structure"')
    expect(html).toContain('id="performance"')
    expect(html).toContain('id="sitemap-robots"')
  })
