...
describe('Use Case: Sidebar Example', () => {
  ...
  test('should generate HTML that matches expected output', async () => {
    ...
    expect(generatedHtml).toContain('<title>Sidebar Configuration Example</title>')
    expect(generatedHtml).toContain('Comprehensive sidebar configuration and navigation examples for BunPress')
    ...
    expect(generatedHtml).toContain('Sidebar Configuration Example')

    // Check for sidebar structure
    expect(generatedHtml).toContain('Overview')
    expect(generatedHtml).toContain('Basic Sidebar')
    expect(generatedHtml).toContain('Nested Groups')
    expect(generatedHtml).toContain('Collapsible Sections')
    expect(generatedHtml).toContain('Custom Links')
    expect(generatedHtml).toContain('Active States')
  ...
  test('should process frontmatter correctly', async () => {
    ...
    expect(html).toContain('Sidebar Configuration Example')
    ...
    expect(html).toContain('/sidebar-example#overview')
    expect(html).toContain('Basic Sidebar')
    expect(html).toContain('/sidebar-example#basic-sidebar')
    expect(html).toContain('Nested Groups')
    expect(html).toContain('/sidebar-example#nested-groups')
  })
  ...
  test('should generate proper heading structure', async () => {
    ...
    expect(html).toContain('id="basic-sidebar"')
    expect(html).toContain('id="nested-groups"')
    expect(html).toContain('id="collapsible-sections"')
    expect(html).toContain('id="custom-links"')
    expect(html).toContain('id="active-states"')
