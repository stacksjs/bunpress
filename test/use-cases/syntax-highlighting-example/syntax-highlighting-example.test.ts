...
describe('Use Case: Syntax Highlighting Example', () => {
  const _testCase = 'syntax-highlighting-example'
  const testDir = '/Users/mac/repos/stacks-org/bunpress/test/use-cases/syntax-highlighting-example'
  ...
  test('should generate HTML that matches expected output', async () => {
    ...
    expect(generatedHtml).toContain('<title>Syntax Highlighting Example</title>')
    expect(generatedHtml).toContain('Comprehensive syntax highlighting examples for various programming languages in BunPress')
    ...
    expect(generatedHtml).toContain('Syntax Highlighting Example')

    // Check for sidebar structure
    expect(generatedHtml).toContain('Overview')
    expect(generatedHtml).toContain('JavaScript/TypeScript')
    expect(generatedHtml).toContain('Python')
    expect(generatedHtml).toContain('Rust')
    expect(generatedHtml).toContain('Go')
    expect(generatedHtml).toContain('Custom Languages')
    expect(generatedHtml).toContain('Line Highlighting')
    expect(generatedHtml).toContain('Copy to Clipboard')
  ...
  test('should process frontmatter correctly', async () => {
    ...
    expect(html).toContain('Syntax Highlighting Example')
    ...
    expect(html).toContain('/syntax-highlighting-example#overview')
    expect(html).toContain('JavaScript/TypeScript')
    expect(html).toContain('/syntax-highlighting-example#javascripttypescript')
    expect(html).toContain('Python')
    expect(html).toContain('/syntax-highlighting-example#python')
  })
  ...
  test('should generate proper heading structure', async () => {
    ...
    expect(html).toContain('id="javascripttypescript"')
    expect(html).toContain('id="python"')
    expect(html).toContain('id="rust"')
    expect(html).toContain('id="go"')
    expect(html).toContain('id="custom-languages"')
    expect(html).toContain('id="line-highlighting"')
    expect(html).toContain('id="copy-to-clipboard"')
  })
  ...
  test('should include code blocks with syntax highlighting', async () => {
    ...
    expect(html).toContain('function greetUser')
    expect(html).toContain('console.log')
    expect(html).toContain('import pandas as pd')
    expect(html).toContain('def load_and_preprocess_data')
