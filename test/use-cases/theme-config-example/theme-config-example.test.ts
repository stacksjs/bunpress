...
describe('Use Case: Theme Config Example', () => {
  ...
  test('should generate HTML that matches expected output', async () => {
    ...
    expect(generatedHtml).toContain('<title>Theme Configuration Example</title>')
    expect(generatedHtml).toContain('Comprehensive theming system and customization options for BunPress documentation')
    ...
    expect(generatedHtml).toContain('Theme Configuration Example')

    // Check for sidebar structure
    expect(generatedHtml).toContain('Overview')
    expect(generatedHtml).toContain('Color Palette')
    expect(generatedHtml).toContain('Typography')
    expect(generatedHtml).toContain('Layout Options')
    expect(generatedHtml).toContain('Component Styling')
    expect(generatedHtml).toContain('Dark Mode')
    expect(generatedHtml).toContain('Custom CSS')
  ...
  test('should process frontmatter correctly', async () => {
    ...
    expect(html).toContain('Theme Configuration Example')
    ...
    expect(html).toContain('/theme-config-example#overview')
    expect(html).toContain('Color Palette')
    expect(html).toContain('/theme-config-example#color-palette')
    expect(html).toContain('Typography')
    expect(html).toContain('/theme-config-example#typography')
  })
  ...
  test('should generate proper heading structure', async () => {
    ...
    expect(html).toContain('id="typography"')
    expect(html).toContain('id="layout-options"')
    expect(html).toContain('id="component-styling"')
    expect(html).toContain('id="dark-mode"')
    expect(html).toContain('id="custom-css"')
  })
